 ...
 *
 * % mkdir build
 * % gcc -Wall -g src/pq_max_array_ordered_client.c \
 *     src/pq_max_array_ordered.c \
 *     src/stack_linked_list.c \
 *     -o build/pq_max_array_ordered_client.out
 *
 * ### Run
 *
 * % more input.txt
 *   10 20 35 100 85 67 35 18 22 21
 * % build/pq_max_array_ordered_client.out 3 < input.txt
 */
int main(int argc, const char *argv[]) {
  ...
  struct OrderedArrayMaxPQ _pq, *pq = &_pq;
