...
#ifndef __unordered_array_max_pq
#define __unordered_array_max_pq

typedef const void *MaxPQ_Key;

struct UnorderedArrayMaxPQ {
  MaxPQ_Key *keys;
  int size;
  int capacity;
  ComparatorFn cmp;
};
typedef struct UnorderedArrayMaxPQ *MaxPQ;
...
#endif // __unordered_array_max_pq
